...
class SleepTimings:
    ...
    BEFORE_BRIDGE_RANGE = (30, TimeRanges.MINUTE*5)  # from 30 seconds to 1 hour. Sleep before bridge
    BALANCE_RECHECK_TIME = TimeRanges.MINUTE * 2  # 2 minutes. Recheck time for stablecoin or native token deposit
    BEFORE_WITHDRAW_RANGE = (30, TimeRanges.MINUTE*10)  # from 30 seconds to 30 minutes. Sleep before withdraw from exchange
